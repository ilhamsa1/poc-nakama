  ...
  return (
    <div className="flex flex-col gap-4 p-2"> 
      <div className="flex gap-2 flex-col p-2">
        <h2 className="text-2xl font-bold">Send a Transaction to Chain with Sign Within an Action</h2>
        <button className="bg-blue-500 rounded-md p-2 text-white" onClick={encrypt}>Sign</button>
      </div>
    </div>
  );
};
